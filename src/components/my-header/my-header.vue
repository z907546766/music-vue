<template lang="html">
  <div id='myHeader'>
      <span class="iconfont icon-mine "></span>
       <h2 ><a href="javascript:;" class="title">乐听音乐</a></h2>
  </div>
</template>
...
/* 此处引入less只能使用相对路径,且minxin函数仅在当前style下有效果*/
